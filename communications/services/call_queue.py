...
BITRIX_STAT_POLL_TIMEOUT_SECONDS = float(os.getenv("BITRIX_STAT_POLL_TIMEOUT_SECONDS", "400"))
BITRIX_STAT_POLL_INTERVAL_SECONDS = float(os.getenv("BITRIX_STAT_POLL_INTERVAL_SECONDS", "10"))
