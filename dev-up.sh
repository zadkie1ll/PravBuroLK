...
docker compose -f services/leadreport_service/docker-compose.yml up -d --build
docker compose -f services/client_search_service/docker-compose.yml up -d --build
