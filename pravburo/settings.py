...
CONTRACT_PAYMENT_RECIPIENT = os.getenv("CONTRACT_PAYMENT_RECIPIENT", "СВИРИДЕНКО СТАНИСЛАВ ВАЛЕРЬЕВИЧ (ИП)")
CONTRACT_PAYMENT_INN = os.getenv("CONTRACT_PAYMENT_INN", "616706684677")
CONTRACT_PAYMENT_KPP = os.getenv("CONTRACT_PAYMENT_KPP", "")
CONTRACT_PAYMENT_ADDRESS = os.getenv(
    "CONTRACT_PAYMENT_ADDRESS",
    "проспект 40-летия Победы, д. 63/17, корп./ст. 3, кв./оф. 328, Ростовская область, г. Ростов-на-Дону",
)
CONTRACT_PAYMENT_CURRENCY = os.getenv("CONTRACT_PAYMENT_CURRENCY", "RUR")
CONTRACT_PAYMENT_BANK = os.getenv("CONTRACT_PAYMENT_BANK", 'ФИЛИАЛ "РОСТОВСКИЙ" АО "АЛЬФА-БАНК"')
CONTRACT_PAYMENT_BIK = os.getenv("CONTRACT_PAYMENT_BIK", "046015207")
CONTRACT_PAYMENT_ACCOUNT = os.getenv("CONTRACT_PAYMENT_ACCOUNT", "40802810426340008508")
CONTRACT_PAYMENT_CORR_ACCOUNT = os.getenv("CONTRACT_PAYMENT_CORR_ACCOUNT", "30101810500000000207")
...
# Bitrix ID бухгалтера — ему ставится задача, когда клиент вносит последний платёж по рассрочке
ACCOUNTANT_BITRIX_ID = os.getenv("ACCOUNTANT_BITRIX_ID", "")
...
# Дублирование завершённых сделок "Сопровождение" (WON) -> "Агенты"
DEAL_DUPLICATION_SOURCE_CATEGORY_ID = int(os.getenv("DEAL_DUPLICATION_SOURCE_CATEGORY_ID", "2"))
DEAL_DUPLICATION_SOURCE_WON_STAGE_ID = os.getenv("DEAL_DUPLICATION_SOURCE_WON_STAGE_ID", "C2:WON")
DEAL_DUPLICATION_TARGET_CATEGORY_ID = int(os.getenv("DEAL_DUPLICATION_TARGET_CATEGORY_ID", "10"))
DEAL_DUPLICATION_TARGET_FIRST_STAGE_ID = os.getenv("DEAL_DUPLICATION_TARGET_FIRST_STAGE_ID", "C10:NEW")
